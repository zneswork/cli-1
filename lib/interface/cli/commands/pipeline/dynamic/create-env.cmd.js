...
const install = new Command({
    ...
    builder: (yargs) => {
        return yargs
            ...
            .example('codefresh create env --repo https://kubernetes-charts.storage.googleapis.com', 'Install chart from public helm repo')
            .example('codefresh get ctx --type helm-repository', 'Get all helm repos')
            .example('codefresh create env --repo my-help-repository', 'Install chart saved repo');
    },
    handler: async (argv) => {
        try {
